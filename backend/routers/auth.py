...
def register_agency_and_admin(user_data: schemas.UserRegister):
    ...
    try:
        # 1. Create the new agency in the ddbb
        ...
        # We pass the agency_id and role inside the app_metadata so our dependencies.py can read it later
        ...
        #3. Create the user's profile in the public.profiles table
...
def login(credentials: schemas.UserLogin):
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"EL ERROR REAL ES: {str(e)}"
        )